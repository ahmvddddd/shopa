...
class ProductsCategoryAdmin extends ConsumerStatefulWidget {
  final String category;
  final List<dynamic> products;

  const ProductsCategoryAdmin({
    super.key,
  ...
  @override
  ConsumerState<ProductsCategoryAdmin> createState() =>
      _ProductsCategoryAdminState();
}

class _ProductsCategoryAdminState extends ConsumerState<ProductsCategoryAdmin> {
